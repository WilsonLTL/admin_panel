<template>
  <vuestic-sidebar :hidden="this.isOpen"
    ...
    <template slot="menu">
      ...
      <sidebar-link-group>
        <span slot="title">
          <span class="sidebar-menu-item-icon entypo entypo-eye"></span>
      ...
      :to="{ name: 'setting' }">
      <span slot="title">
      <span class="sidebar-menu-item-icon vuestic-icon vuestic-icon-settings"></span>
